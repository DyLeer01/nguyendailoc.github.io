...
const qy = (i, a, o) => {
  ...
  , Yy = ({className: i}) => x.jsx("img", {
    src: "/logo/uniqlo.webp",
    alt: "Uniqlo",
    className: `${i} object-contain`
})
  , Gy = ({className: i}) => x.jsx("img", {
    src: "/logo/samsung.webp",
    alt: "Samsung",
    className: `${i} object-contain`
})
  , Xy = ({className: i}) => x.jsx("img", {
    src: "/logo/mastercard.webp",
    alt: "Mastercard",
    className: `${i} object-contain`
})
  , Qy = ({className: i}) => x.jsx("img", {
    src: "/logo/traveloka.webp",
    alt: "Traveloka",
    className: `${i} object-contain`
})
  , Zy = ({className: i}) => x.jsx("img", {
    src: "/logo/lazada.webp",
    alt: "Lazada",
    className: `${i} object-contain`
})
  , Ky = ({className: i}) => x.jsx("img", {
    src: "/logo/vinfast.webp",
    alt: "VinFast",
    className: `${i} object-contain`
})
  , Jy = ({className: i}) => x.jsx("img", {
    src: "/logo/cgv.webp",
    alt: "CGV",
    className: `${i} object-contain`
})
  , Fy = ({className: i}) => x.jsx("img", {
    src: "/logo/pippit-ai.webp",
    alt: "Pippit AI",
    className: `${i} object-contain`
})
  , Py = ({className: i}) => x.jsx("img", {
    src: "/logo/unilever.webp",
    alt: "Unilever",
    className: `${i} object-contain`
})
  , Wy = ({className: i}) => x.jsx("img", {
    src: "/logo/th-true-milk.webp",
    alt: "TH True Milk",
    className: `${i} object-contain`
})
  , Ni = ["https://uploads.onecompiler.io/44jejqpgz/44jejqz6s/LOC.jpg", "/marquee/row1-02.webp", "/marquee/row1-03.webp", "/marquee/row1-04.webp", "/marquee/row1-05.webp", "/marquee/row3-01.webp", "/marquee/row3-02.webp", "https://uploads.onecompiler.io/44jejqpgz/44jejqz6s/LOC.jpg", "/marquee/row3-04.webp", "/marquee/row3-05.webp", "/marquee/row2-01.webp", "https://uploads.onecompiler.io/44jejqpgz/44jejqz6s/LOC.jpg", "/marquee/row2-03.webp", "/marquee/row2-04.webp", "/marquee/row2-05.webp"]
    ...
    return x.jsxs("div", {
        ...
        children: [x.jsx("div", {
            ...
            children: x.jsxs("div", {
                ...
                children: [x.jsx("div", {
                    className: "absolute inset-0 bg-[url('HinhNen.webp')] bg-cover bg-center"
                }), x.jsx("div", {
    ...
    children: [
        ...
        x.jsxs("div", {
            ...
            children: [
                ...
                children: [x.jsx("div", {
                    className: "absolute inset-0 z-0 bg-[url('HinhNen.webp')] bg-cover bg-center"
                }), x.jsx("div", {
